...
import { BadRequestError, NotFoundError, OrderStatus, requireAuth, validateRequest } from '@vegasdevapps/tickets-common';
...
router.post('/api/orders', requireAuth, validation, validateRequest, async (req: Request, res: Response) => {
    ...
    // Buils the order and save it to the database
